        ...
        return (
            <div className="card1">
                <div className="dargImg">
                    <img src={bars} width="100%" alt="image" />
                </div>
                <div className="secondDiv">
                    <div className="time">
                        {(item.showInput || item.done || item.showSelect) && <img src={trash} className="trashIcon" onClick={() => this.props.removeData(index)} alt="image" />}
                        <div>{item.time}</div>
                    </div>
                    <div className="data">
                        {(!item.done && !item.showSelect && !item.showInput) ?
                            <div className="choosing">
                                ...
                                {<img src={edit} className="iconChoose icon" onClick={() => this.props.setShowing(true, index)} alt="image" />}
                            </div> :
                            <div className="filling">
                                ...
                                {item.showInput && <div className="insert">
                                    ...
                                    />}
                                    {<img src={done} className="vi" onClick={() => this.props.setDone(index)} alt="image" />}
                                </div>}
                            </div>}
                    </div>
                </div>
